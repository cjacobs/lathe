...
module carriage_bed()
{
    ...
    {
        {
            cube([carriage_width, carriage_length, carriage_thickness]);
        }
...
module carriage()
{
    ...
    translate([0, -carriage_width/2-carriage_back_offset, 0]) 
    {
        ...
        // front rail
        color(aluminum) translate([0, bed_ways_width+rail_width+gib_width, -rail_thickness]) cube([carriage_width, rail_width, gib_thickness]);
